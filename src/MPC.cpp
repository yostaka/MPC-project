...
// valuables in a single vector.
// These variables below set a starting index for each state / control parameters
// in the vector.
size_t x_start = 0;
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t=1; t<N; t++) {
      ...
      // Calculate cost constraints for time t + 1 through t + N (throughout the loop)
...
//  options += "Numeric max_cpu_time          0.5\n";
  options += "Numeric max_cpu_time          20\n";
